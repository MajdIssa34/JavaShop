...
public class Inventory {
    ...
    public ArrayList<ItemInterface> searchItems(String searchTerm) {
        return searchStrategy.searchItems(stock, searchTerm);
    }
    ...
    public void refreshInventory(Inventory inv){
        ArrayList<ItemInterface> tempStock = new ArrayList<>();
        for(ItemInterface i : inv.stock){
            tempStock.add(i);
        }
    ...
    public boolean contains(ItemInterface item){
        ...
        for(ItemInterface i : this.stock){
            if(i.isOf(item.getDefinition())){
                return true;
            }
        }
        return false;
